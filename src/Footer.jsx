...
const Footer = () => {
  ...
  const socials = [
    {
      name: "GitHub",
      href: "https://github.com/AlokaChathu",
      icon: (
    ...
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/chathumini-aloka-246453385?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="h-6 w-6">
    ...
    {
      name: "Email",
      href: "mailto:chathuminialoka02@gmail.com",
      icon: (
        <svg viewBox="0 0 24 24" fill="currentColor" className="h-6 w-6">
      ...
      <div className="max-w-6xl mx-auto px-6 py-14">
        ...
        <div className="flex flex-col-reverse md:flex-row md:items-center md:justify-between gap-6">
          ...
          <p className="text-xs text-gray-500 text-center md:text-left">
            © {year} Chathumini Aloka. All rights reserved.
          </p>
